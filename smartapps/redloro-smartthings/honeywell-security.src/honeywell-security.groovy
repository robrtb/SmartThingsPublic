...
def page1() {
  dynamicPage(name: "page1", install: true, uninstall: true) {
    ...
    section("Honeywell Panel") {
      ...
      input name: "pluginType", type: "text", title: "Plugin Type", required: true, defaultValue: "envisalink"
      input "securityCode", "password", title: "Security Code", description: "User code to arm/disarm the security panel", required: false, defaultValue: "1317"
      input "enableDiscovery", "bool", title: "Discover Zones (WARNING: all existing zones will be removed)", defaultValue: true
    }
    ...
    section("Smart Home Monitor") {
      input "enableSHM", "bool", title: "Integrate with Smart Home Monitor", required: true, defaultValue: false
    }
  }
}
